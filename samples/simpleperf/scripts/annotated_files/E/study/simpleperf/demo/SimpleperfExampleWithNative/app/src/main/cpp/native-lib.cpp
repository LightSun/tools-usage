/* [file] acc_p: 99.995192%, p: 5.305091% */#include <jni.h>
...
/* acc_p: 97.285605%, p: 2.595503%        */    return a + atoi("1");
                                            }

/* [func] acc_p: 99.995192%, p: 5.305091% */static void* BusyLoopThread(void*) {
                                                volatile int i = 0;
                                                while (true) {
/* acc_p: 99.995192%, p: 5.305091%        */        i = CallFunction(i);
                                                }
                                                return nullptr;
                                            }
